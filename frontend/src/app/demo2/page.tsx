...
const Demo: React.FC = () => {
  ...
  // Function to speak the word aloud using Web Speech API
          ...
          if (blob) {
            ...
            try {
              ...
              if (
                ...
                // Add a space if no hand is detected and read the word aloud
                setWord((prev) => {
                  if (prev.slice(-1) !== " ") {
                    speakWord(prev.trim()); // Speak the word when space is added
                    return prev + " ";
                  }
                  return prev;
                });
